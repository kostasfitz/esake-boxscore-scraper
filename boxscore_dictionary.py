...
def boxscore_dictionary(driver_path, website, game_number):
    ...
    refs = driver.find_element(by=By.XPATH,
                               value="/html/body/center/div/div[5]/div/table/tbody/tr[2]/td/div/div/center[1]/table/tbody/tr/td[1]/div[2]").get_attribute(
        'innerText')
    ...
    home_dic = {'name': home_temp.strip('\t'), 'players': []}
    dic['teams'].append(home_dic)
    ...
    dic['teams'][0]['players'] = home_player_list
    ...
    away_dic = {'name': away_temp.strip('\t'), 'players': []}
    dic['teams'].append(away_dic)
    ...
    dic['teams'][1]['players'] = away_player_list
